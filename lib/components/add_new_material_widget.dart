...
import 'add_new_material_model.dart';
export 'add_new_material_model.dart';

class AddNewMaterialWidget extends StatefulWidget {
  const AddNewMaterialWidget({super.key});

  @override
  State<AddNewMaterialWidget> createState() => _AddNewMaterialWidgetState();
}

class _AddNewMaterialWidgetState extends State<AddNewMaterialWidget> {
  late AddNewMaterialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewMaterialModel());
